...
public class QuaternionAlignmentServiceTest {
    ...
    public void whenOriginalExample_thenRmsdMatches() {
        ...
        Structure structure1 = new Structure("1tst",
                ...
                new LabelSelection("A", 5), 4,
                new LabelSelection("A", 6), 5,
                new LabelSelection("A", 7), 6),
        ...
        assertEquals(0.719106, alignmentResult.getRootMeanSquareDeviation().value(), Helpers.DELTA); // 0.001 precision
    }
