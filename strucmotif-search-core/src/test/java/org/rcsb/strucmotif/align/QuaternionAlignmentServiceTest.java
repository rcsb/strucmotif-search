...
class QuaternionAlignmentServiceTest {
    ...
    public void init() {
        ...
        ResidueTypeResolver residueTypeResolver = new DefaultResidueTypeResolver(new StrucmotifConfig());
        structureReader = new DefaultStructureReader(residueTypeResolver);
    }

    @Test
    void whenOriginalExample_thenRmsdMatches() {
        // https://theobald.brandeis.edu/qcp/main.c
        Structure structure1 = new DefaultStructure("1tst",
                new String[] { "1" },
                new int[] { 0 },
                new String[] { "A", "1" },
                new String[] { "1" },
        ...
        Structure structure2 = new DefaultStructure("2tst",
                new String[] { "1" },
                new int[] { 0 },
                new String[] { "A", "1" },
                new String[] { "1" },
        ...
        assertEquals(0.719106, alignmentResult.rootMeanSquareDeviation(), Helpers.RELAXED_DELTA);
    }

    @Test
    void whenSelfAlign_thenRmsdIsZeroAndTransformationIsIdentity() {
        Structure structure = new DefaultStructure("1tst",
                new String[] { "1" },
                new int[] { 0 },
                new String[] { "A", "1" },
                new String[] { "1" },
        ...
        double rmsd11 = alignment11.rootMeanSquareDeviation();
    ...
    void whenAlign1And2_thenRmsdAndTransformationMatches() {
        ...
        double rmsd12 = alignment12.rootMeanSquareDeviation();
    ...
    void whenAlign3And4_thenRmsdAndTransformationMatches() {
        Structure structure3 = new DefaultStructure("1tst",
                new String[] { "1" },
                new int[] { 0 },
                new String[] { "A", "1" },
                new String[] { "1" },
        ...
        Structure structure4 = new DefaultStructure("2tst",
                new String[] { "1" },
                new int[] { 0 },
                new String[] { "A", "1" },
                new String[] { "1" },
        ...
        double rmsd34 = alignment34.rootMeanSquareDeviation();
    ...
    void whenAminopeptidaseExampleWithAllAtoms_thenRmsdInflated() {
        ...
        assertEquals(3.167, result.rootMeanSquareDeviation(), Helpers.DELTA);
    }
    ...
    void whenAminopeptidaseExampleWithNonAmbiguous_thenRmsdMatches() {
        ...
        AlignmentResult result = alignmentService.align(residues1, residues2, AtomPairingScheme.ALL);
        assertEquals(2.211, result.rootMeanSquareDeviation(), Helpers.RELAXED_DELTA);
    }
}
