 ...
 */
public record MotifHit(String motifIdentifier, List<LabelSelection> labelSelections, List<ResidueType> residueTypes, float rmsd, float[] transformation) implements Hit {
    @Override
